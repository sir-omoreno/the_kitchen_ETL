...
-- 
SELECT "Recipe_Name", "Url"."URL", "Recipes"."Main_Ingredient" FROM "Recipes"
INNER JOIN "Url" ON "Recipes"."Main_Ingredient" = "Url"."Main_Ingredient"
WHERE "Recipes"."Main_Ingredient" = 'Eggs';